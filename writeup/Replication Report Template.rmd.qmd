...
Based on the fact that the sample size of 256  gives us 80% power and that some participant data might be excluded according to the exclusion criteria (which I think will be around 10%), I plan to run a sample of 282.
